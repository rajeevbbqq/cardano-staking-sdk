    ...
    return function (g) {
        return function (f) {
            return Data_Newtype.over()()(SpecT)(Control_Monad_Writer_Trans.mapWriterT((function () {
                var $79 = Data_Functor.map(dictFunctor)(Data_Functor.map(Data_Tuple.functorTuple)(Data_Functor.map(Data_Functor.functorArray)(f)));
                return function ($80) {
                    return $79(g($80));
                };
            })()));
        ...
        return function (f) {
            var onTest = function (name) {
                return Data_Newtype.over()()(Test_Spec_Tree.Item)(function (item) {
                    var e = function (g) {
                        return g((function () {
                            var $81 = f(new TestWithName(name));
                            return function ($82) {
                                return $81(item.example(Data_Function.applyFlipped($82)));
                            };
                        })());
                    };
                    return {
...
var focus = function (dictFocusWarning) {
    return function (dictMonad) {
        return Data_Newtype.over()()(SpecT)(Control_Monad_Writer_Trans.mapWriterT(Data_Functor.map(((dictMonad.Bind1()).Apply0()).Functor0())(Data_Functor.map(Data_Tuple.functorTuple)(function (xs) {
            var $76 = Data_Foldable.any(Data_Foldable.foldableArray)(Data_HeytingAlgebra.heytingAlgebraBoolean)(Data_Foldable.any(Test_Spec_Tree.treeFoldable)(Data_HeytingAlgebra.heytingAlgebraBoolean)((function () {
                var $83 = Data_Newtype.un()(Test_Spec_Tree.Item);
                return function ($84) {
                    return (function (v) {
                        return v.isFocused;
                    })($83($84));
...
var itOnly = function (dictFocusWarning) {
    return function (dictMonad) {
        return function (dictExample) {
            var $85 = Data_Functor.map(Data_Functor.functorFn)(focus()(dictMonad));
            var $86 = it(dictMonad)(dictExample);
            return function ($87) {
                return $85($86($87));
            };
        };
...
var describeOnly = function (dictFocusWarning) {
    return function (dictMonad) {
        var $88 = Data_Functor.map(Data_Functor.functorFn)(focus()(dictMonad));
        var $89 = describe(dictMonad);
        return function ($90) {
            return $88($89($90));
        };
    };
...
var collect = function (dictFunctor) {
    var $91 = Data_Functor.map(dictFunctor)(Test_Spec_Tree.discardUnfocused);
    var $92 = Control_Monad_Writer_Trans.execWriterT(dictFunctor);
    var $93 = Data_Newtype.un()(SpecT);
    return function ($94) {
        return $91($92($93($94)));
    };
};
