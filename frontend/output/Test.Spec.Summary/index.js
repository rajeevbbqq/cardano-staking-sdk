...
var semigroupCount = {
    append: function (v) {
        return function (v1) {
            return Count(Data_Semiring.add(Data_Semiring.semiringRecord()(Data_Semiring.semiringRecordCons({
...
var monoidCount = {
    mempty: Data_Semiring.zero(Data_Semiring.semiringRecord()(Data_Semiring.semiringRecordCons({
        reflectSymbol: function () {
            return "failed";
        }
    })()(Data_Semiring.semiringRecordCons({
...
var successful = function (groups) {
    return (Data_Newtype.un()(Count)(summarize(groups))).failed === 0;
};
module.exports = {
    Count: Count,
    summarize: summarize,
