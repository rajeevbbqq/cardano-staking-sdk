...
var haytingAlgebraOnly = {
    ff: false,
    tt: true,
    implies: Data_Newtype.over2()()(Only)(Data_HeytingAlgebra.implies(Data_HeytingAlgebra.heytingAlgebraBoolean)),
    conj: Data_Newtype.over2()()(Only)(Data_HeytingAlgebra.conj(Data_HeytingAlgebra.heytingAlgebraBoolean)),
    disj: Data_Newtype.over2()()(Only)(Data_HeytingAlgebra.disj(Data_HeytingAlgebra.heytingAlgebraBoolean)),
    not: Data_Newtype.over()()(Only)(Data_HeytingAlgebra.not(Data_HeytingAlgebra.heytingAlgebraBoolean))
};
    ...
    var go = function (v) {
        if (v instanceof TestGroup) {
            return Data_Functor.voidLeft(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity))(Control_Monad_State_Class.modify(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))((function () {
                var $153 = Data_HeytingAlgebra.disj(Data_Tuple.heytingAlgebraTuple(haytingAlgebraOnly)(haytingAlgebraOnly))(hasOnly(v.value0.value1));
                var $154 = Data_HeytingAlgebra.disj(Data_Tuple.heytingAlgebraTuple(haytingAlgebraOnly)(haytingAlgebraOnly))(new Data_Tuple.Tuple(v.value2, Data_HeytingAlgebra.ff(haytingAlgebraOnly)));
                return function ($155) {
                    return $153($154($155));
                };
            })()))(v.value3);
    ...
    var go = function (v1) {
        return function (v2) {
            if (v2 instanceof TestGroup) {
                var $88 = Data_Newtype.un()(Skip)(v2.value1);
                if ($88) {
            ...
            if (v2 instanceof TestUnit) {
                var v3 = Data_Newtype.un()(Only)(Data_HeytingAlgebra.conj(haytingAlgebraOnly)(Data_HeytingAlgebra.implies(haytingAlgebraOnly)(v.value0)(v1))(Data_HeytingAlgebra.implies(haytingAlgebraOnly)(v.value1)(v2.value2))) && !Data_Newtype.un()(Skip)(v2.value1);
                if (v3) {
...
var failure = (function () {
    var $156 = Control_Monad_Error_Class.throwError(Effect_Aff.monadThrowAff);
    return function ($157) {
        return $156(Effect_Exception.error($157));
    };
})();
var describe = suite;
...
var collectTests = (function () {
    var $158 = Data_Functor.map(Effect_Aff.functorAff)(Data_List.reverse);
    var $159 = walkSuite(function (v) {
        return function (v1) {
