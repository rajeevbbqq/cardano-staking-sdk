...
var showRenderingMode = {
    show: Data_Show_Generic.genericShow(genericRenderingMode)(Data_Show_Generic.genericShowSum(Data_Show_Generic.genericShowConstructor(Data_Show_Generic.genericShowArgsNoArguments)({
...
var showEraseParam = {
    show: Data_Show_Generic.genericShow(genericEraseParam)(Data_Show_Generic.genericShowSum(Data_Show_Generic.genericShowConstructor(Data_Show_Generic.genericShowArgsNoArguments)({
        reflectSymbol: function () {
            return "ToEnd";
        }
    }))(Data_Show_Generic.genericShowSum(Data_Show_Generic.genericShowConstructor(Data_Show_Generic.genericShowArgsNoArguments)({
...
var showColor = {
    show: Data_Show_Generic.genericShow(genericColor)(Data_Show_Generic.genericShowSum(Data_Show_Generic.genericShowConstructor(Data_Show_Generic.genericShowArgsNoArguments)({
        reflectSymbol: function () {
            return "Black";
        }
    }))(Data_Show_Generic.genericShowSum(Data_Show_Generic.genericShowConstructor(Data_Show_Generic.genericShowArgsNoArguments)({
...
var showGraphicsParam = {
    show: Data_Show_Generic.genericShow(genericGraphicsParam)(Data_Show_Generic.genericShowSum(Data_Show_Generic.genericShowConstructor(Data_Show_Generic.genericShowArgsNoArguments)({
        reflectSymbol: function () {
            return "Reset";
        }
    }))(Data_Show_Generic.genericShowSum(Data_Show_Generic.genericShowConstructor(Data_Show_Generic.genericShowArgsArgument(showRenderingMode))({
        reflectSymbol: function () {
            return "PMode";
        }
    }))(Data_Show_Generic.genericShowSum(Data_Show_Generic.genericShowConstructor(Data_Show_Generic.genericShowArgsArgument(showColor))({
        reflectSymbol: function () {
            return "PForeground";
        }
    }))(Data_Show_Generic.genericShowConstructor(Data_Show_Generic.genericShowArgsArgument(showColor))({
        reflectSymbol: function () {
            return "PBackground";
        }
    })))))
...
var showEscapeCode = {
    show: Data_Show_Generic.genericShow(genericEscapeCode)(Data_Show_Generic.genericShowSum(Data_Show_Generic.genericShowConstructor(Data_Show_Generic.genericShowArgsArgument(Data_Show.showInt))({
        reflectSymbol: function () {
            return "Up";
        }
    ...
    }))(Data_Show_Generic.genericShowSum(Data_Show_Generic.genericShowConstructor(Data_Show_Generic.genericShowArgsArgument(showEraseParam))({
        reflectSymbol: function () {
            return "EraseData";
        }
    }))(Data_Show_Generic.genericShowSum(Data_Show_Generic.genericShowConstructor(Data_Show_Generic.genericShowArgsArgument(showEraseParam))({
    ...
    }))(Data_Show_Generic.genericShowSum(Data_Show_Generic.genericShowConstructor(Data_Show_Generic.genericShowArgsArgument(Data_List_Types.showNonEmptyList(showGraphicsParam)))({
        reflectSymbol: function () {
            return "Graphics";
        }
    }))(Data_Show_Generic.genericShowSum(Data_Show_Generic.genericShowConstructor(Data_Show_Generic.genericShowArgsNoArguments)({
...
var ordRenderingMode = {
    compare: function (x) {
        return function (y) {
            ...
            throw new Error("Failed pattern match at Ansi.Codes (line 132, column 1 - line 132, column 54): " + [ x.constructor.name, y.constructor.name ]);
        };
    },
    Eq0: function () {
...
var ordEraseParam = {
    compare: function (x) {
        return function (y) {
            ...
            throw new Error("Failed pattern match at Ansi.Codes (line 89, column 1 - line 89, column 48): " + [ x.constructor.name, y.constructor.name ]);
        };
    },
    Eq0: function () {
        return eqEraseParam;
...
var ordColor = {
    compare: function (x) {
        return function (y) {
            ...
            throw new Error("Failed pattern match at Ansi.Codes (line 167, column 1 - line 167, column 38): " + [ x.constructor.name, y.constructor.name ]);
        };
    },
    Eq0: function () {
        return eqColor;
...
var ordGraphicsParam = {
    compare: function (x) {
        return function (y) {
            ...
            throw new Error("Failed pattern match at Ansi.Codes (line 110, column 1 - line 110, column 54): " + [ x.constructor.name, y.constructor.name ]);
        };
    },
    Eq0: function () {
...
var ordEscapeCode = {
    compare: function (x) {
        return function (y) {
            ...
            throw new Error("Failed pattern match at Ansi.Codes (line 44, column 1 - line 44, column 48): " + [ x.constructor.name, y.constructor.name ]);
        };
    },
    Eq0: function () {
        return eqEscapeCode;
...
module.exports = {
    ...
    colorCode: colorCode,
    genericEscapeCode: genericEscapeCode,
    eqEscapeCode: eqEscapeCode,
    ordEscapeCode: ordEscapeCode,
    showEscapeCode: showEscapeCode,
    genericEraseParam: genericEraseParam,
    eqEraseParam: eqEraseParam,
    ordEraseParam: ordEraseParam,
    showEraseParam: showEraseParam,
    genericGraphicsParam: genericGraphicsParam,
    eqGraphicsParam: eqGraphicsParam,
    ordGraphicsParam: ordGraphicsParam,
    showGraphicsParam: showGraphicsParam,
    genericRenderingMode: genericRenderingMode,
    eqRenderingMode: eqRenderingMode,
    ordRenderingMode: ordRenderingMode,
    showRenderingMode: showRenderingMode,
